...
public class SwiftOpenVPNFlutterPlugin: NSObject, FlutterPlugin {
    ...
    private static var EVENT_CHANNEL_VPN_STAGE : String = "id.superfuture.openvpn_sf_flutter/vpnstage"
    private static var METHOD_CHANNEL_VPN_CONTROL : String = "id.superfuture.openvpn_sf_flutter/vpncontrol"
