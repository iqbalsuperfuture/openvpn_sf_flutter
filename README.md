...
Open VPNExtension > PacketTunnelProvider.swift and copy paste this script <a href="https://raw.githubusercontent.com/sf/openvpn_sf_flutter/master/example/ios/VPNExtension/PacketTunnelProvider.swift">PacketTunnelProvider.swift</a>
...
2. Add this to your files in `android` folder (special thanks to https://github.com/sf/openvpn_sf_flutter/issues/10). Otherwise connection will not be
...
## Licenses
* [openvpn_sf_flutter](https://github.com/sf/openvpn_sf_flutter/blob/master/LICENSE) for this plugin
